...
void HAL_TIM_PWM_MspDeInit(TIM_HandleTypeDef* htim_pwm)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA10     ------> TIM1_CH3
    */
    HAL_GPIO_DeInit(GPIOA, M1_PWM2_Pin|M1_PWM1_Pin|MAGSEN_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB1     ------> TIM3_CH4
    */
    HAL_GPIO_DeInit(GPIOA, M2_PWM1_Pin|M2_PWM2_Pin);

    HAL_GPIO_DeInit(GPIOB, M2_2_Pin|M2_1_Pin);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA5     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(GPIOA, M3_1_Pin|M3_PWM1_Pin|M3_PWM2_Pin|M3_2_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB9     ------> TIM4_CH4
    */
    HAL_GPIO_DeInit(ULTSEN_INPUT_GPIO_Port, ULTSEN_INPUT_Pin);
