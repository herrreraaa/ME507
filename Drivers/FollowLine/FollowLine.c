...
/*!
 * @brief Line following algorithm using one line sensor.
 */
void FollowLine(){
...
/*!
 * @brief Line following algorithm using two line sensors.
 */
void FollowLine2(){
LHS_status = LineSenGetStatusLEFT();
...
/*!
 * @brief Drives robot in a straight line
 */
void DriveStraight(){
...
/*!
 * @brief Drives the robot in a circle that is approximately the radius of the ME507's competition arena
 */
void GoInCircle(){
